...
class LayerControls(Gtk.EventBox, Loggable):
    ...
    def __init__(self, bLayer, app):
        ...
        self.bLayer = bLayer
        self.timeline = self.bLayer.get_timeline()
        self.app = app
        ...
        self.timeline.connect("layer-added", self.__timelineLayerAddedCb)
        self.timeline.connect("layer-removed", self.__timelineLayerRemovedCb)
    ...
    def __del__(self):
        ...
        self.timeline.disconnect_by_func(self.__timelineLayerAddedCb)
        self.timeline.disconnect_by_func(self.__timelineLayerRemovedCb)
    ...
    def __updateActions(self):
        ...
        layers_count = len(self.timeline.get_layers())
